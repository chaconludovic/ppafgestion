...
/**
 * JPA 2 Data Access Object for {@link com.eldoraludo.ppafgestion.domain.Itemlieudedepot}.
 * Note: do not use @Transactional in the DAO layer.
 */
@Named
@Singleton
public class ItemlieudedepotDao extends GenericDao<Itemlieudedepot, Integer> {
    public ItemlieudedepotDao() {
        super(Itemlieudedepot.class);
    }
}